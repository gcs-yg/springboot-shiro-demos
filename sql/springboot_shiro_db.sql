...
Source Database       : springboot_shiro_db

Target Server Type    : MYSQL
Target Server Version : 50643
File Encoding         : 65001

Date: 2019-05-08 15:10:57
*/
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='菜单管理';
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='角色';

-- ----------------------------
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('13', 'admin', 'admina', '1498801511');
INSERT INTO `sys_role` VALUES ('14', '普通管理员', 'putong', '1557216946');
...
) ENGINE=InnoDB AUTO_INCREMENT=258 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='角色与菜单对应关系';
...
INSERT INTO `sys_role_menu` VALUES ('251', '14', '1');
INSERT INTO `sys_role_menu` VALUES ('252', '14', '4');
INSERT INTO `sys_role_menu` VALUES ('253', '14', '13');
INSERT INTO `sys_role_menu` VALUES ('254', '14', '14');
INSERT INTO `sys_role_menu` VALUES ('255', '14', '15');
INSERT INTO `sys_role_menu` VALUES ('256', '14', '16');
INSERT INTO `sys_role_menu` VALUES ('257', '14', '17');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918', '1', '2434387555@qq.com', '13647910412', '1557299274', '0:0:0:0:0:0:0:1', 'upload/adminAvatar/201707/1499675749475head.jpg', '1', '1498801511');
...
INSERT INTO `sys_user` VALUES ('9', 'test', '9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08', '1', 'test@126.com', '15860769534', '1557217055', '0:0:0:0:0:0:0:1', null, '1', '1557216980');
...
INSERT INTO `sys_user_login_log` VALUES ('409', '1557215069', '0:0:0:0:0:0:0:1', '1', 'WINDOWS_10', 'CHROME');
INSERT INTO `sys_user_login_log` VALUES ('410', '1557215134', '0:0:0:0:0:0:0:1', '1', 'WINDOWS_10', 'CHROME');
INSERT INTO `sys_user_login_log` VALUES ('411', '1557217020', '0:0:0:0:0:0:0:1', '1', 'WINDOWS_10', 'CHROME');
INSERT INTO `sys_user_login_log` VALUES ('412', '1557217055', '0:0:0:0:0:0:0:1', '9', 'WINDOWS_10', 'CHROME');
INSERT INTO `sys_user_login_log` VALUES ('413', '1557242575', '0:0:0:0:0:0:0:1', '1', 'WINDOWS_10', 'CHROME');
INSERT INTO `sys_user_login_log` VALUES ('414', '1557298846', '0:0:0:0:0:0:0:1', '1', 'WINDOWS_10', 'CHROME');
INSERT INTO `sys_user_login_log` VALUES ('415', '1557299274', '0:0:0:0:0:0:0:1', '1', 'WINDOWS_10', 'CHROME');
...
CREATE TABLE `sys_user_role` (
  ...
  `role_id` bigint(20) DEFAULT NULL COMMENT '角色ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户与角色对应关系';
...
INSERT INTO `sys_user_role` VALUES ('75', '9', '14');
